...
export default function setupPiggy(scene: Main) {
    ...
    scene.pig = scene.physics.add.sprite(pigX, Y_POS, "piggy-animations", "1-0.png");
    scene.pig.setDepth(10);
    scene.pig.setScale(0.4);
    // Animations
    const frameNames1 = scene.anims.generateFrameNames('piggy-animations', {
        start: 0, end: 8, zeroPad: 0,
        prefix: '1-', suffix: '.png'
    });
    scene.anims.create({ key: 'blink', frames: frameNames1, frameRate: 8, repeat: -1, repeatDelay: 2000, delay: 2000 });
    const frameNames2 = scene.anims.generateFrameNames('piggy-animations', {
        start: 0, end: 15, zeroPad: 0,
        prefix: '2-', suffix: '.png'
    });
    scene.anims.create({ key: 'walk', frames: frameNames2, frameRate: 24, repeat: -1 });
    const frameNames3 = scene.anims.generateFrameNames('piggy-animations', {
        start: 0, end: 15, zeroPad: 0,
        prefix: '3-', suffix: '.png'
    });
    ...
    const frameNames5 = scene.anims.generateFrameNames('piggy-animations', {
